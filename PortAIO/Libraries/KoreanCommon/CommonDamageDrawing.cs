namespace KoreanCommon
{
    ...
    public class CommonDamageDrawing
    {
        ...
        {
            return ((Active) && (_amountOfDamage != null) && ((CommonMenu.getdamageindicator()) || CommonMenu.getkillableindicator()));
        }
            ...
            if (Enabled())
            {
                            ...
                            .Where(h => h.IsVisible && h.IsEnemy && h.IsValid && h.IsHPBarRendered))
                {
                    ...
                    if (damage > 0)
                    {
                        ...
                        if (CommonMenu.getkillableindicator() && (damage > champ.Health + 50f))
                        {
                        ...
                        if (CommonMenu.getdamageindicator())
                        {
