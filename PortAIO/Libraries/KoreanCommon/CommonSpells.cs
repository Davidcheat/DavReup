namespace KoreanCommon
{
    ...
    public class CommonSpells : IEnumerable
    {
        ...
        public void AddSpell(CommonSpell spell)
        {
            ...
            spell.UseOnComboMenu = CommonMenu.getComboCH(string.Format("use{0}tocombo", slot));
            spell.UseOnHarasMenu = CommonMenu.getHarassCH(string.Format("use{0}toharas", slot));
            spell.UseOnLaneClearMenu = CommonMenu.getLaneClearCH(string.Format("use{0}tolaneclear", slot));
            SpellList.Add(spell);
        }
