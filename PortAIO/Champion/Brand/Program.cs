    ...
    class Program
    {
        ...
        public static void Load()
        {
            try
            {
                ...
                _comboProvider = new BrandCombo(1050, new BrandQ(SpellSlot.Q), new BrandW(SpellSlot.W), new BrandE(SpellSlot.E), new BrandR(SpellSlot.R));
                ...
                rOptions.Add("healthDifference", new Slider("% Health difference", 60, 1, 100));
                ...
                miscMenu.Add("manaH", new Slider("Mana Manager Harass", 50, 1, 100));
                miscMenu.Add("manaLC", new Slider("Mana Manager Lane Clear", 80, 1, 100));
