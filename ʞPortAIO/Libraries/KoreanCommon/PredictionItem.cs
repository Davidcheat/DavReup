namespace KoreanCommon
{
    ...
    internal class PredictionItem
    {
        ...
        public readonly LeagueSharp.Common.Spell PredictionSpell;

        public readonly AIHeroClient Target;

        private bool targetImmovable;

        public PredictionItem(AIHeroClient target, LeagueSharp.Common.Spell predictionSpell, KoreanPredictionTypes type = KoreanPredictionTypes.Slow)
        {
